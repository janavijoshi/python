...
#result of membership operator is also in True or False
vowels=["a","e","i","o","u"]
print ("a" in vowels)
print ("h" in vowels)
print ("h" not in vowels)
print ("u" in vowels)
...
a=1
b=1
print (a is b) #true. here  'a' and 'b' are in the same memory location
print (id(a))
print (id(b)) #if identity of objects is the same then 'id' will also be the same

a=None
b=None
print (a is b) #true
#None type in python always has the same memory location so, they always have the same identity